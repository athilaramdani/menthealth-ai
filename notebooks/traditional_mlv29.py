...
# **Pipeline v29** — Klasifikasi Kesehatan Mental Berbasis Audio
#
# ─────────────────────────────────────────────────────────────────────
#  v29 = LOOCV + SMOTE + PCA-Fused Features + Lasso FS + Ensemble
#
...
MODELS_DIR  = os.path.join(PROJECT_ROOT, "models", "ml_v29")
RESULTS_DIR = os.path.join(PROJECT_ROOT, "results", "v29")
...
csv_path = os.path.join(RESULTS_DIR, "metrics", "v29_results.csv")
df_results.to_csv(csv_path, index=False)
print("\n" + "=" * 80)
print(f"RINGKASAN v29 — LOOCV (102 folds, SMOTE + Lasso FS + PCA-Fused Features + Ensemble)")
print("=" * 80)
