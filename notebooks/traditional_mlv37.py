...
# **Pipeline v37** — Klasifikasi Kesehatan Mental Berbasis Multimodal
#
# ─────────────────────────────────────────────────────────────────────
#  v37 = LOOCV + SMOTE + Block-wise Lasso FS + Audio/Text Fusion + Deep Learning
#
...
#  [4] Menggunakan Block-wise Lasso Feature Selection: MFCC, Spec, W2V, dan Teks
#      diseleksi secara terpisah sebelum digabung.
...
MODELS_DIR  = os.path.join(PROJECT_ROOT, "models", "ml_v37")
RESULTS_DIR = os.path.join(PROJECT_ROOT, "results", "v37")
...
csv_path = os.path.join(RESULTS_DIR, "metrics", "v37_results.csv")
df_results.to_csv(csv_path, index=False)
print("\n" + "=" * 80)
print(f"RINGKASAN v37 — LOOCV (Audio+Teks Fusion + Deep Neural Net + 4 Model Klasik)")
print("=" * 80)
